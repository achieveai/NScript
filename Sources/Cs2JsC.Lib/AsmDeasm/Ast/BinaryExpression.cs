...
namespace Cs2JsC.Lib.AsmDeasm.Ast
{
    class BinaryExpression : SimpleExpression
    {
            ...
            : base(context, instructionBlock, expressions)
        {
            ...
            {
                case Cs2JsC.Lib.AsmDeasm.Ops.IlOpCode.Add:
                case Cs2JsC.Lib.AsmDeasm.Ops.IlOpCode.AddOvfSigned:
                case Cs2JsC.Lib.AsmDeasm.Ops.IlOpCode.AddOvfUnsigned:
                    this.Operator = BinaryOperator.Add;
                    break;
                case Cs2JsC.Lib.AsmDeasm.Ops.IlOpCode.And:
                    this.Operator = BinaryOperator.BitwiseAnd;
                    break;
                case Cs2JsC.Lib.AsmDeasm.Ops.IlOpCode.BranchIfEqual:
                case Cs2JsC.Lib.AsmDeasm.Ops.IlOpCode.CheckEquals:
                    this.Operator = BinaryOperator.IdentityEquality;
                    break;
                case Cs2JsC.Lib.AsmDeasm.Ops.IlOpCode.BranchIfGreaterOrEqual:
                case Cs2JsC.Lib.AsmDeasm.Ops.IlOpCode.BranchIfGreaterOrEqualUnsigned:
                ...
                case Cs2JsC.Lib.AsmDeasm.Ops.IlOpCode.BranchIfGreaterUnsigned:
                case Cs2JsC.Lib.AsmDeasm.Ops.IlOpCode.BranchIfGreater:
                    this.Operator = BinaryOperator.GreaterThan;
                    break;
                case Cs2JsC.Lib.AsmDeasm.Ops.IlOpCode.BranchIfLessOrEqualUnsigned:
                case Cs2JsC.Lib.AsmDeasm.Ops.IlOpCode.BranchIfLessOrEqual:
                ...
                case Cs2JsC.Lib.AsmDeasm.Ops.IlOpCode.BranchIfLessThan:
                case Cs2JsC.Lib.AsmDeasm.Ops.IlOpCode.BranchIfLessThanUnsigned:
                    this.Operator = BinaryOperator.LessThan;
                    break;
                case Cs2JsC.Lib.AsmDeasm.Ops.IlOpCode.BranchIfNotEqualsUnsigned:
                    this.Operator = BinaryOperator.ValueInequality;
                    break;
                case Cs2JsC.Lib.AsmDeasm.Ops.IlOpCode.DivUnsigned:
                case Cs2JsC.Lib.AsmDeasm.Ops.IlOpCode.Div:
                    this.Operator = BinaryOperator.Divide;
                    break;
                case Cs2JsC.Lib.AsmDeasm.Ops.IlOpCode.MulOvf:
                case Cs2JsC.Lib.AsmDeasm.Ops.IlOpCode.Mul:
                    this.Operator = BinaryOperator.Multiply;
                    break;
                case Cs2JsC.Lib.AsmDeasm.Ops.IlOpCode.Or:
                    this.Operator = BinaryOperator.BitwiseOr;
                    break;
                case Cs2JsC.Lib.AsmDeasm.Ops.IlOpCode.Remainder:
                case Cs2JsC.Lib.AsmDeasm.Ops.IlOpCode.RemainderUnsigned:
                    this.Operator = BinaryOperator.Modulus;
                    break;
                case Cs2JsC.Lib.AsmDeasm.Ops.IlOpCode.ShiftLeft:
                    this.Operator = BinaryOperator.ShiftLeft;
                    break;
                case Cs2JsC.Lib.AsmDeasm.Ops.IlOpCode.ShiftRightUnsigned:
                case Cs2JsC.Lib.AsmDeasm.Ops.IlOpCode.ShiftRight:
                    this.Operator = BinaryOperator.ShiftRight;
                    break;
                case Cs2JsC.Lib.AsmDeasm.Ops.IlOpCode.SubOvf:
                case Cs2JsC.Lib.AsmDeasm.Ops.IlOpCode.Sub:
                    this.Operator = BinaryOperator.Subtract;
                    break;
                case Cs2JsC.Lib.AsmDeasm.Ops.IlOpCode.Xor:
                case Cs2JsC.Lib.AsmDeasm.Ops.IlOpCode.Switch:
