...
| `ParenthesizedPattern` | ✅ Supported | Validated in `Lang10Features.cs::ParenthesizedConstantPattern`. Lowers to the inner pattern. Runtime-gated by `Lang9PatternExecutionTests` (V8 execution snapshot). |
