            ...
            sources = new Dictionary<string, (string outName, string[] files, string directory, string[] refs, string keyFile, bool isDebug)>()
            {
                ["mscorlib"] = (
                    ...
                    new string[] {
                        ...
                        @"Decimal.cs",
                        @"Delegate.cs",
                        @"Diagnostics\CodeAnalysis\SetsRequiredMembersAttribute.cs",
                        ...
                        @"Runtime\CompilerServices\INotifyCompletion.cs",
                        ...
                        @"Runtime\CompilerServices\IsExternalInit.cs",
                        ...
                        @"Runtime\CompilerServices\ModuleInitializerAttribute.cs",
                        ...
                        @"Runtime\CompilerServices\RequiredMemberAttribute.cs",
                        ...
                        @"Threading\CancellationToken.cs",
                        @"Threading\CancellationTokenSource.cs",
                        @"Threading\Interlocked.cs",
                        @"Threading\Task.cs",
                        @"Threading\ManualResetValuetaskSourceCore.cs",
                        @"Threading\ValueTask.cs",
                        @"Type.cs",
                        @"UInt16.cs",
                        @"UInt32.cs",
                        @"UInt64.cs",
                ...
                ["realScript"] = (
                    ...
                    new string[]
                    {
                        ...
                        @"Lang8IndexRangeTests.cs",
                        @"Lang9FeatureExecutionTests.cs",
                        @"Lang9Features.cs",
                        @"Lang9RecordTests.cs",
                        @"Lang9PatternExecutionTests.cs",
                        @"Lang10Features.cs",
                        @"Lang11Features.cs",
                        @"Lang11RequiredTests.cs",
                        @"Lang12Features.cs",
                        @"Lang13Features.cs",
                        @"Lang13ExecutionTests.cs",
                        @"MathAlgorithms.cs",
                        @"NumberOperations.cs",
