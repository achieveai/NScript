...
namespace Windows.UI.Xaml.Controls
{
	...
	{
		DependencyProperty BringIntoViewOnFocusChangeProperty
		{
			get;
		}
		...
		DependencyProperty IsDeferredScrollingEnabledProperty
		{
			get;
		}
		...
		bool GetIsDeferredScrollingEnabled([In] DependencyObject element);
		void SetIsDeferredScrollingEnabled([In] DependencyObject element, [In] bool isDeferredScrollingEnabled);
		bool GetBringIntoViewOnFocusChange([In] DependencyObject element);
		void SetBringIntoViewOnFocusChange([In] DependencyObject element, [In] bool bringIntoViewOnFocusChange);
	}
}
