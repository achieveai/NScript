...
Sunlight_Framework_UI_Test_LiveBinderTests.typeId = "n";
...
function Sunlight__Framework__UI__Test__LiveBinderTests__Setup() {
  Sunlight__Framework__UI__Test__LiveBinderTests__oneWayBinder = Sunlight__Framework__UI__Helpers__SkinBinderInfo_factory(System__NativeArray$1__op_Implicit(System_ArrayG_$Func_$Object_x_Object$_$_.__ctor([function Sunlight__Framework__UI__Test__LiveBinderTests__Setup_del(obj) {
    return System__Type__CastType(Sunlight_Framework_UI_Test_TestViewModelA, obj).get_propStr1();
  }])), System__NativeArray$1__op_Implicit(System_ArrayG_$String$_.__ctor(["PropStr1"])), function Sunlight__Framework__UI__Test__LiveBinderTests__Setup_del2(tar, val) {
  ...
  Sunlight__Framework__UI__Test__LiveBinderTests__twoWayBinder = Sunlight__Framework__UI__Helpers__SkinBinderInfo_factory0(System__NativeArray$1__op_Implicit(System_ArrayG_$Func_$Object_x_Object$_$_.__ctor([function Sunlight__Framework__UI__Test__LiveBinderTests__Setup_del3(obj) {
    ...
    System__Type__CastType(Sunlight_Framework_UI_Test_TestViewModelA, tar).set_propStr1(System__Type__CastType(String, val));
  }, System__NativeArray$1__op_Implicit(System_ArrayG_$String$_.__ctor(["PropStr1"])), function Sunlight__Framework__UI__Test__LiveBinderTests__Setup_del5(tar, val) {
    System__Type__CastType(Sunlight_Framework_UI_Test_TestViewModelA, tar).set_propStr1(System__Type__CastType(String, val));
...
Sunlight_Framework_UI_Test_NScriptsTemplateTests.typeId = "o";
...
Sunlight_Framework_UI_Test_SkinBinderHelperTests.typeId = "p";
...
Sunlight_Framework_UI_Test_TestListView.typeId = "q";
...
function Sunlight__Framework__UI__Test__TestListView__TestChildSkin() {
  ...
  vmAs = System_ArrayG_$TestViewModelB$_.__ctor([(stmtTemp1 = Sunlight__Framework__UI__Test__TestViewModelB_factory(), stmtTemp1.set_propStr1("StrTest"), stmtTemp1), (stmtTemp10 = Sunlight__Framework__UI__Test__TestViewModelB_factory(), stmtTemp10.set_propStr1("TestStr"), stmtTemp10), (stmtTemp11 = Sunlight__Framework__UI__Test__TestViewModelB_factory(), stmtTemp11.set_propStr1("TestTT1"), stmtTemp11)]);
...
Sunlight_Framework_UI_Test_ManualTemplateTests.typeId = "r";
...
Sunlight_Framework_UI_Test_UIElementTests.typeId = "s";
...
Sunlight_Framework_UI_Helpers_SkinBinderInfo.typeId = "u";
function Sunlight__Framework__UI__Helpers__SkinBinderInfo_factory1(propertyGetterPath, targetPropertySetter, binderType, objectIndex, forwardConverter, defaultValue) {
  var this_;
...
function Sunlight__Framework__UI__Helpers__SkinBinderInfo_factory2(propertyGetterPath, targetPropertySetterWithArg, targetPropertySetterArg, binderType, objectIndex, forwardConverter, defaultValue, extraObjectIndex) {
  var this_;
  this_ = new Sunlight_Framework_UI_Helpers_SkinBinderInfo();
...
function Sunlight__Framework__UI__Helpers__SkinBinderInfo_factory3(propertyGetterPath, propertyNames, targetPropertySetter, targetPropertySetterArg, binderType, objectIndex, binderIndex, forwardConverter, defaultValue, extraObjectIndex) {
  var this_;
  this_ = new Sunlight_Framework_UI_Helpers_SkinBinderInfo();
...
ptyp_.mode = 0;
ptyp_.__ctor = function Sunlight__Framework__UI__Helpers__SkinBinderInfo____ctor1(propertyGetterPath, targetPropertySetter, binderType, objectIndex, forwardConverter, defaultValue) {
  this.binderIndex = -1;
...
ptyp_.__ctor0 = function Sunlight__Framework__UI__Helpers__SkinBinderInfo____ctor2(propertyGetterPath, targetPropertySetterWithArg, targetPropertySetterArg, binderType, objectIndex, forwardConverter, defaultValue, extraObjectIndex) {
  this.binderIndex = -1;
  this.extraObjectIndex = -1;
  this.propertyGetterPath = propertyGetterPath;
...
ptyp_.__ctor1 = function Sunlight__Framework__UI__Helpers__SkinBinderInfo____ctor(propertyGetterPath, propertyNames, targetPropertySetter, binderType, objectIndex, binderIndex, forwardConverter, defaultValue) {
  this.binderIndex = -1;
  this.extraObjectIndex = -1;
  this.propertyGetterPath = propertyGetterPath;
...
ptyp_.__ctor3 = function Sunlight__Framework__UI__Helpers__SkinBinderInfo____ctor3(propertyGetterPath, propertyNames, targetPropertySetter, targetPropertySetterArg, binderType, objectIndex, binderIndex, forwardConverter, defaultValue, extraObjectIndex) {
  this.binderIndex = -1;
  this.extraObjectIndex = -1;
  this.propertyGetterPath = propertyGetterPath;
  this.propertyNames = propertyNames;
...
ptyp_.setTargetValue = function Sunlight__Framework__UI__Helpers__SkinBinderInfo__SetTargetValue(target, value, extraObjectArray) {
  ...
  if (propertySetterMode === 16)
    ...
    if (extraObjectArray[binderInfo.extraObjectIndex] !== null)
      this.targetPropertySetterWithArg(target, extraObjectArray[binderInfo.extraObjectIndex], System__BooleanNative__op_Implicit(false));
...
Sunlight_Framework_UI_Test_TestViewModelA.typeId = "w";
...
Sunlight_Framework_UI_Helpers_LiveBinder.typeId = "bc";
...
Sunlight_Framework_TaskScheduler.typeId = "bd";
...
Sunlight_Framework_TestWindowTimer.typeId = "be";
...
Sunlight_Framework_UI_Test_NScriptsTemplatesClass.typeId = "bf";
...
Sunlight_Framework_Observables_ExtensibleObservableObject.typeId = "bg";
...
Sunlight_Framework_Binders_ContextBindableObject.typeId = "bh";
...
ptyp_.__ctor1 = function Sunlight__Framework__Binders__ContextBindableObject____ctor() {
  this.__ctor0();
...
Sunlight_Framework_UI_UIElement.typeId = "bi";
...
ptyp_.__ctor2 = function Sunlight__Framework__UI__UIElement____ctor(element) {
  this.__ctor1();
...
Sunlight_Framework_UI_UISkinableElement.typeId = "bj";
...
ptyp_.__ctor3 = function Sunlight__Framework__UI__UISkinableElement____ctor(element) {
...
Sunlight_Framework_UI_Test_TestViewModelB.typeId = "bk";
...
Sunlight_Framework_UI_Test_TestSkinableWithTestUIElementPart.typeId = "bl";
...
ptyp_.__ctor4 = function Sunlight__Framework__UI__Test__TestSkinableWithTestUIElementPart____ctor(element) {
...
Sunlight_Framework_UI_Test_TestUIElement.typeId = "bm";
...
ptyp_.__ctor3 = function Sunlight__Framework__UI__Test__TestUIElement____ctor(element) {
  this.__ctor2(element);
};
...
Sunlight_Framework_UI_ListView.typeId = "bo";
...
ptyp_.itemSkin = null;
ptyp_.__ctor3 = function Sunlight__Framework__UI__ListView____ctor(element) {
  this.__ctor2(element);
...
ptyp_.internalDispose1 = function Sunlight__Framework__UI__ListView__InternalDispose() {
  var items, itemCount, iItem;
  items = this.items;
  itemCount = items.get_count();
  if (itemCount > 0) {
...
Sunlight_Framework_Task.typeId = "bp";
...
Sunlight_Framework_UI_Skin.typeId = "bq";
...
Sunlight_Framework_UI_Helpers_SkinInstance.typeId = "br";
...
Sunlight_Framework_UI_ListViewItem.typeId = "bs";
...
ptyp_.__ctor4 = function Sunlight__Framework__UI__ListViewItem____ctor(element) {
  this.__ctor3(element);
};
...
Sunlight_Framework_UI_Helpers_BinderType.typeId = "bw";
...
System__Type__RegisterReferenceType(Boolean0, "System.BooleanNative", Object, []);
...
Sunlight_Framework_WindowTimer.typeId = "by";
...
Sunlight_Framework_TaskHandle.typeId = "bz";
...
System_NotSupportedException.typeId = "bi";
...
function Sunlight_Framework_UI_Test_ValueIfTrue(T, $5fcallStatiConstructor) {
  ...
  ValueIfTrue$1_$T$_.typeId = "cc$" + T.typeId + "$";
...
function System_ArrayG(T, $5fcallStatiConstructor) {
  ...
  ArrayG$1_$T$_.typeId = "cd$" + T.typeId + "$";
...
function System_Func(T1, TRes, $5fcallStatiConstructor) {
  ...
  Func$2_$T1_x_T1$_.typeId = "ce$" + T1.typeId + "_" + TRes.typeId + "$";
...
function System_Collections_Generic_NumberDictionary(TValue, $5fcallStatiConstructor) {
  var Enumerator_$TValue$_, NumberDictionary$1_$TValue$_, KeyValuePair$2_$Number_x_Number$_, IEnumerable$1_$KeyValuePair$2_$Number_x_Number$_$_, $5f_initTracker, $5f_initTracker0;
  ...
  NumberDictionary$1_$TValue$_.typeId = "cf$" + TValue.typeId + "$";
  KeyValuePair$2_$Number_x_Number$_ = System_Collections_Generic_KeyValuePair(Number, TValue, $5fcallStatiConstructor);
  KeyValuePair$2_$Number_x_Number$_ = System_Collections_Generic_KeyValuePair(Number, TValue, $5fcallStatiConstructor);
  IEnumerable$1_$KeyValuePair$2_$Number_x_Number$_$_ = System_Collections_Generic_IEnumerable(System_Collections_Generic_KeyValuePair(Number, TValue, $5fcallStatiConstructor), $5fcallStatiConstructor);
  ...
  ptyp_.copyTo = function System__Collections__Generic__NumberDictionary$1__CopyTo(array, index) {
    ...
    for (i = 0; i < keys.V_get_Length(); i++)
      array.setValue(i + index, System__Type__BoxTypeInstance(KeyValuePair$2_$Number_x_Number$_, KeyValuePair$2_$Number_x_Number$_.__ctor(keys.get_item(i), this.get_item(keys.get_item(i)))));
  };
...
function System_Collections_Generic_Queue(T, $5fcallStatiConstructor) {
  ...
  Queue$1_$T$_.typeId = "cg$" + T.typeId + "$";
  IEnumerable$1_$T$_ = System_Collections_Generic_IEnumerable(T, $5fcallStatiConstructor);
...
function System_Collections_Generic_List(T, $5fcallStatiConstructor) {
  ...
  List$1_$T$_.typeId = "ch$" + T.typeId + "$";
  IList$1_$T$_ = System_Collections_Generic_IList(T, $5fcallStatiConstructor);
  IEnumerable$1_$T$_ = System_Collections_Generic_IEnumerable(T, $5fcallStatiConstructor);
...
function System_Collections_Generic_StringDictionary(TValue, $5fcallStatiConstructor) {
  ...
  StringDictionary$1_$TValue$_.typeId = "ci$" + TValue.typeId + "$";
...
function System_Action(T1, $5fcallStatiConstructor) {
  ...
  Action$1_$T1$_.typeId = "cj$" + T1.typeId + "$";
...
function System_Action0(T1, T2, $5fcallStatiConstructor) {
  ...
  Action$2_$T1_x_T1$_.typeId = "ck$" + T1.typeId + "_" + T2.typeId + "$";
  ...
  Action$2_$T1_x_T1$_._tri = function() {
    ...
    T1 = T1;
    T2 = T2;
    Action$2_$T1_x_T1$_ = System_Action0(T1, T2, true);
  };
  if ($5fcallStatiConstructor)
...
function System_Collections_Generic_KeyValuePair(K, V, $5fcallStatiConstructor) {
  ...
  KeyValuePair$2_$K_x_K$_.typeId = "bb$" + K.typeId + "_" + V.typeId + "$";
  ...
  KeyValuePair$2_$K_x_K$_.__ctor = function System__Collections__Generic__KeyValuePair$2____ctor(key, value) {
    var this_;
    this_ = KeyValuePair$2_$K_x_K$_.getDefaultValue();
    this_.key = key;
    this_.val = value;
    return this_;
  };
...
function System_Collections_Generic_NumberDictionary_Enumerator(TValue, $5fcallStatiConstructor) {
  var KeyValuePair$2_$Number_x_Number$_, Enumerator_$TValue$_, IEnumerator$1_$KeyValuePair$2_$Number_x_Number$_$_, $5f_initTracker;
  ...
  Enumerator_$TValue$_.typeId = "bc$" + TValue.typeId + "$";
  KeyValuePair$2_$Number_x_Number$_ = System_Collections_Generic_KeyValuePair(Number, TValue, $5fcallStatiConstructor);
  IEnumerator$1_$KeyValuePair$2_$Number_x_Number$_$_ = System_Collections_Generic_IEnumerator(System_Collections_Generic_KeyValuePair(Number, TValue, $5fcallStatiConstructor), $5fcallStatiConstructor);
  ...
  ptyp_.system__Collections__IEnumerator__get_Current = function System__Collections__Generic__NumberDictionary$1$2fEnumerator__System__Collections__IEnumerator__get_Current() {
    return System__Type__BoxTypeInstance(KeyValuePair$2_$Number_x_Number$_, this.get_current());
  };
  ptyp_.__ctor = function System__Collections__Generic__NumberDictionary$1$2fEnumerator____ctor(dict) {
    this.dict = dict;
    this.keys = this.dict.get_keys().V_GetEnumerator_h$i$();
  };
...
function System_Collections_Generic_Queue_QueueEnumerator(T, $5fcallStatiConstructor) {
  ...
  QueueEnumerator_$T$_.typeId = "bd$" + T.typeId + "$";
...
function System_Collections_Generic_ListEnumerator(T, $5fcallStatiConstructor) {
  ...
  ListEnumerator$1_$T$_.typeId = "be$" + T.typeId + "$";
  IEnumerator$1_$T$_ = System_Collections_Generic_IEnumerator(T, $5fcallStatiConstructor);
...
function System_Collections_Generic_StringDictionary_Enumerator(TValue, $5fcallStatiConstructor) {
  var KeyValuePair$2_$String_x_String$_, Enumerator_$TValue$_, IEnumerator$1_$KeyValuePair$2_$String_x_String$_$_, $5f_initTracker;
  ...
  Enumerator_$TValue$_.typeId = "bf$" + TValue.typeId + "$";
  KeyValuePair$2_$String_x_String$_ = System_Collections_Generic_KeyValuePair(String, TValue, $5fcallStatiConstructor);
  ...
  ptyp_.system__Collections__IEnumerator__get_Current = function System__Collections__Generic__StringDictionary$1$2fEnumerator__System__Collections__IEnumerator__get_Current() {
    return System__Type__BoxTypeInstance(KeyValuePair$2_$String_x_String$_, this.get_current());
  };
  ptyp_.__ctor = function System__Collections__Generic__StringDictionary$1$2fEnumerator____ctor(dict) {
    this.dict = dict;
    this.keys = this.dict.get_keys().V_GetEnumerator_h$j$();
  };
...
function System_Collections_Generic_IEnumerable(T, $5fcallStatiConstructor) {
  ...
  IEnumerable$1_$T$_.typeId = "h$" + T.typeId + "$";
...
function System_ArrayG_Enumerator(T, $5fcallStatiConstructor) {
  ...
  Enumerator_$T$_.typeId = "bg$" + T.typeId + "$";
  IEnumerator$1_$T$_ = System_Collections_Generic_IEnumerator(T, $5fcallStatiConstructor);
...
function System_Collections_Generic_IEnumerator(T, $5fcallStatiConstructor) {
  ...
  IEnumerator$1_$T$_.typeId = "k$" + T.typeId + "$";
...
function System_Collections_Generic_IList(T, $5fcallStatiConstructor) {
  ...
  IList$1_$T$_.typeId = "bh$" + T.typeId + "$";
  IEnumerable$1_$T$_ = System_Collections_Generic_IEnumerable(T, $5fcallStatiConstructor);
...
System_Collections_Generic_KeyValuePair_$Number_x_Number$_ = System_Collections_Generic_KeyValuePair(Number, Sunlight_Framework_Task);
...
System_Action_$INotifyPropertyChanged_x_INotifyPropertyChanged$_ = System_Action0(Sunlight_Framework_Observables_INotifyPropertyChanged, String);
System_Collections_Generic_KeyValuePair_$String_x_String$_0 = System_Collections_Generic_KeyValuePair(String, System_Action_$INotifyPropertyChanged_x_INotifyPropertyChanged$_);
...
System_Collections_Generic_KeyValuePair_$String_x_String$_1 = System_Collections_Generic_KeyValuePair(String, System_Delegate);
...
System_Collections_Generic_KeyValuePair_$String_x_String$_2 = System_Collections_Generic_KeyValuePair(String, Sunlight_Framework_UI_UIElement);
...
System_Collections_Generic_KeyValuePair_$String_x_String$_3 = System_Collections_Generic_KeyValuePair(String, System_Int32);
...
System_Collections_Generic_KeyValuePair_$Number_x_Number$_._tri();
...
function TestTemplateVMB_CssBinding() {
  if (!TestTemplateVMB_CssBinding_var)
    TestTemplateVMB_CssBinding_var = Sunlight__Framework__UI__Skin_factory(Sunlight_Framework_UI_UISkinableElement, Sunlight_Framework_UI_Test_TestViewModelB, TestTemplateVMB_CssBinding_factory, "1");
  return TestTemplateVMB_CssBinding_var;
};
function styleSetter(dom, val) {
  dom.style.height = val;
};
function TestTemplateVMB_StyleBinding_factory(skinFactory, doc) {
  var objStorage, htmlRoot, domStore;
...
TestTemplateVMB_StyleBinding_var = null;
function TestTemplateVMB_StyleBinding() {
  if (!TestTemplateVMB_StyleBinding_var)
    TestTemplateVMB_StyleBinding_var = Sunlight__Framework__UI__Skin_factory(Sunlight_Framework_UI_UISkinableElement, Sunlight_Framework_UI_Test_TestViewModelB, TestTemplateVMB_StyleBinding_factory, "2");
  return TestTemplateVMB_StyleBinding_var;
};
function TestTemplateVMB_AttrBinding_factory(skinFactory, doc) {
  var objStorage, htmlRoot, domStore;
...
TestTemplateVMB_AttrBinding_var = null;
function TestTemplateVMB_AttrBinding() {
  if (!TestTemplateVMB_AttrBinding_var)
    TestTemplateVMB_AttrBinding_var = Sunlight__Framework__UI__Skin_factory(Sunlight_Framework_UI_UISkinableElement, Sunlight_Framework_UI_Test_TestViewModelB, TestTemplateVMB_AttrBinding_factory, "3");
  return TestTemplateVMB_AttrBinding_var;
};
...
function TestTemplateB_PropertyBinding_factory(skinFactory, doc) {
  var objStorage, htmlRoot, domStore;
...
TestTemplateB_PropertyBinding_var = null;
function TestTemplateB_PropertyBinding() {
  if (!TestTemplateB_PropertyBinding_var)
    TestTemplateB_PropertyBinding_var = Sunlight__Framework__UI__Skin_factory(Sunlight_Framework_UI_Test_TestSkinableWithTestUIElementPart, Sunlight_Framework_UI_Test_TestViewModelB, TestTemplateB_PropertyBinding_factory, "4");
  return TestTemplateB_PropertyBinding_var;
};
function TestTemplateVMB1_factory(skinFactory, doc) {
  var objStorage, htmlRoot, domStore;
...
function TestTemplateVMB1() {
  if (!TestTemplateVMB1_var)
    TestTemplateVMB1_var = Sunlight__Framework__UI__Skin_factory(Sunlight_Framework_UI_UISkinableElement, Sunlight_Framework_UI_Test_TestViewModelB, TestTemplateVMB1_factory, "5");
  return TestTemplateVMB1_var;
};
