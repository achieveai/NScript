namespace CssParser.Test
{
    ...
    public class CssGrammerUnitTest
    {
        ...
        [TestMethod]
        public void CssVariableValidation_ComprehensiveTest()
        {
            // Part 1: Test that CSS variables defined in :root can be used successfully
            var cssWithDefinedVariables = @"
                :root { 
            ...
            // Part 2: Test that undefined CSS variables throw ParseException
            var cssWithUndefinedVariable = @"
                :root { 
                    --primary-color: #ff0000;
                }
            ...
            catch (ParseException ex)
            {
                ...
                Assert.IsTrue(ex.Message.Contains("--undefined-color"), 
                    $"Error message should contain the undefined variable name. Actual: {ex.Message}");
