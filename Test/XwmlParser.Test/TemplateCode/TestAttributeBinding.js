...
function TestAttributeBinding_factory(skinFactory, doc) {
  ...
  if (!(domStore = DocStorageGetter(doc))[0]) {
    ...
    tmplStore[0] = tmplStore[0] ? tmplStore[0] : [Sunlight__Framework__UI__Helpers__SkinBinderInfo_factory([getter], Sunlight__Framework__UI__Helpers__SkinBinderHelper__SetAttribute, "testattr", 131073, 0, null, null, 0)];
  }
