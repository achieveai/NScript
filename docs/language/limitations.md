...
| Switch expressions | ✅ Supported | Constant / declaration / discard / relational / logical / negated arms all lower through the shared `PatternMatcher`. Property, positional, list, and extended-property patterns are still open — see [`csharp9-13-status.md`](./csharp9-13-status.md). |
