...
function StructClass__ToString(this_) {
  return String__Format("{0}, {1}", System_ArrayG_$Object$_.__ctor([Type__BoxTypeInstance(System_Int32, this_.i), this_.foo]));
};
...
function StructClass2__GetFooValue(st2, st1) {
  return StructClass2__get_Value(st2) >= 0 ? StructClass2__get_FooValue(st2) : StructClass__get_FooValue(st1);
};
ptyp_ = new System_ValueType();
