...
function TestUIElementPropertyBinding_factory(skinFactory, doc) {
  ...
  if (!(domStore = DocStorageGetter(doc))[0]) {
    ...
    tmplStore[0] = tmplStore[0] ? tmplStore[0] : [Sunlight__Framework__UI__Helpers__SkinBinderInfo_factory([getter], ["PropInt1"], setter, 17, 0, 0, null, 10)];
  }
  ...
  return Sunlight__Framework__UI__Helpers__SkinInstance_factory(skinFactory, htmlRoot, [objStorage[0]], objStorage, tmplStore[0], null, 1, 0);
};
