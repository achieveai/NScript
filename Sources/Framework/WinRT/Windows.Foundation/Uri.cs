...
{
	[Activatable(typeof(IUriRuntimeClassFactory), 100794368u), DualApiPartition(version = 100794368u), MarshalingBehavior(MarshalingType.Agile), Static(typeof(IUriEscapeStatics), 100794368u), Threading(ThreadingModel.Both), Version(100794368u)]
	public sealed class Uri : IUriRuntimeClass, IUriRuntimeClassWithAbsoluteCanonicalUri
	{
		...
		public static extern string UnescapeComponent([In] string toUnescape);
		public static extern string EscapeComponent([In] string toEscape);
	}
}
