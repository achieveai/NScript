...
{
	[Activatable(100794368u), MarshalingBehavior(MarshalingType.Agile), Muse(Version = 100794368u), Static(typeof(IXmlDocumentStatics), 100794368u), Threading(ThreadingModel.Both), Version(100794368u)]
