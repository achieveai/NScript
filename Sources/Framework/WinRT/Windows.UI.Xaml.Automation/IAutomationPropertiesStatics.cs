...
namespace Windows.UI.Xaml.Automation
{
	...
	internal interface IAutomationPropertiesStatics
	{
		...
		DependencyProperty LiveSettingProperty
		{
			get;
		}
		...
		AutomationLiveSetting GetLiveSetting([In] DependencyObject element);
		void SetLiveSetting([In] DependencyObject element, [In] AutomationLiveSetting value);
	}
}
