...
SkinBinderHelperTests.typeId = "u";
...
function Element__AddClassName(this_, className) {
  ...
  while ((index = this_.className.indexOf(className, index)) != -1) {
    if ((index == 0 || String__get_Item(this_.className, index - 1) == " ") && (index == this_.className.length - className.length || String__get_Item(this_.className, index + className.length) == " "))
      return;
    index++;
  }
