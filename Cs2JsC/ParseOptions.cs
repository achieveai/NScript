...
namespace Cs2JsC
{
    ...
    public class ParseOptions
    {
        ...
        {
            Console.WriteLine("Cs2JsC -outJs <JSFileName> -references <references (dll paths)... > -entryAssembly <assembly with entrypoint> [-pluginConfig <plugin for JsGenerator>] [-pluginHintPath <; seperated directories to find plugin dlls in>] [-referenceHintPath <;seperated directories to find reference dlls in>]");
            Environment.Exit(1);
        }
