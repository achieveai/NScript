...
namespace System.Collections.Generic
{
    ...
    public class NumberDictionary<TValue> : INumberDictionary<TValue>
    {
        ...
        public void CopyTo(Array array, int index)
        {
            ...
            for (int i = 0; i < keys.Length; i++)
            {
                array.SetValue(i + index, new KeyValuePair<Number, TValue>(keys[i], this[keys[i]]));
            }
        }
        ...
        [Script(@"
            ...
            ")]
        private extern NativeArray<Number> GetKeys();
        ...
        [Script(@"
            return ({}).constructor.keys(this.@{[mscorlib]System.Collections.Generic.NumberDictionary`1::innerDict}).length;
            ")]
