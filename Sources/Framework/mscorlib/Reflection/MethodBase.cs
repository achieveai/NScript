//-----------------------------------------------------------------------
// <copyright file="MethodBase.cs" company="">
...
namespace System.Reflection
{
	...
	{
		public extern virtual MethodImplAttributes MethodImplementationFlags
		{
			get;
		}
		...
		public extern virtual CallingConventions CallingConvention
		{
			get;
		}
		...
		public extern virtual bool IsGenericMethodDefinition
		{
			get;
		}
		...
		public extern virtual bool ContainsGenericParameters
		{
			get;
		}
		...
		public extern virtual bool IsGenericMethod
		{
			get;
		}
		...
		public extern virtual bool IsSecurityCritical
		{
			get;
		}
		...
		public extern virtual bool IsSecuritySafeCritical
		{
			get;
		}
		...
		public extern virtual bool IsSecurityTransparent
		{
			get;
		}
		...
		public extern bool IsHideBySig
		{
			get;
		}
		...
		internal extern string FullName
		{
			get;
		}
		...
		/// <exception cref="T:System.ArgumentException">
		///   <paramref name="handle" /> is invalid.</exception>
		public extern static MethodBase GetMethodFromHandle(RuntimeMethodHandle handle, RuntimeTypeHandle declaringType);
		...
		public extern static bool operator ==(MethodBase left, MethodBase right);
		...
		public extern virtual Type[] GetGenericArguments();
		...
		/// </PermissionSet>
		public extern virtual MethodBody GetMethodBody();
	}
}
