...
function RealScript__StructClass__ToString(this_) {
  return System__String__Format("{0}, {1}", System_ArrayG_$Object$_.__ctor([System_Int32.box(this_.i), this_.foo]));
};
...
function RealScript__StructClass2__GetFooValue(st2, st1) {
  return RealScript__StructClass2__get_Value(st2) >= 0 ? RealScript__StructClass2__get_FooValue(st2) : RealScript__StructClass__get_FooValue(st1);
};
ptyp_ = new System_ValueType();
