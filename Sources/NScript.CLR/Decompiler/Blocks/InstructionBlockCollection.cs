...
namespace NScript.CLR.Decompiler.Blocks
{
    class InstructionBlockCollection : Block
    {
        ...
        public override IlInstruction GetInstructionAt(int i)
        {
        ...
        protected override void AddChild(Block block)
        {
            ...
            if (lastBlock != null &&
                ...
                lastBlock.Instruction.FlowType == FlowType.Branch ||
                lastBlock.Instruction.FlowType == FlowType.ConditionalBranch ||
                lastBlock.Instruction.FlowType == FlowType.Return ||
                lastBlock.Instruction.FlowType == FlowType.Leave))
            {
