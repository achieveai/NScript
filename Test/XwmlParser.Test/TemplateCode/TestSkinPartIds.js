...
function TestSkinPartIds_factory(skinFactory, doc) {
  ...
  if (!(domStore = DocStorageGetter(doc))[0]) {
    ...
    domStore[0].innerHTML = "<div> <div>Test</div> </div>";
  ...
  return Sunlight__Framework__UI__Helpers__SkinInstance_factory(skinFactory, htmlRoot, [objStorage[0]], objStorage, tmplStore[0], {
    "Part1": 0
  }, 0, 0);
};
